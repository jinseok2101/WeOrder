          ...
          <>
            ...
            <div className="space-y-3">
              <button
                ...
                className="w-[320px] h-8 flex items-center justify-center space-x-2 bg-[#FEE500] hover:bg-[#FCE000] text-[#191919] rounded-[4px] text-xs font-bold transition-colors mx-auto"
              >
              ...
              {clientId ? (
                <div className="w-full flex justify-center h-8">
                  <div id="realGoogleButtonAuth" className="w-full flex justify-center h-8"></div>
                </div>
              ) : (
                <button
                  type="button"
                  ...
                  className="w-[320px] h-8 flex items-center justify-center space-x-2 bg-white border border-gray-200 hover:bg-gray-50 text-gray-700 rounded-[4px] text-xs font-bold transition-colors shadow-sm mx-auto"
                >
